                  ...
                  <div className="footer-widgets">
                    <div className="widget footer-branding">
                      ...
                      <p className="site-logo">
                        <Link to={safePrefix('/')}><img src={safePrefix(_.get(this.props, 'pageContext.site.siteMetadata.footer.logo_img') + '?auto=format&q=65&fit=crop&h=65')} alt="Logo" loading="lazy" width="100%" height="40" /></Link>
                      </p>
                       : 
