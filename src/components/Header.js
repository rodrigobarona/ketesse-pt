                ...
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <p className="site-logo">
                      <Link to={safePrefix('/')}>
                        <img src={safePrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo_img') + '?auto=format&q=65&fit=crop&h=40')} alt="Logo" loading="lazy" width="100%" height="70" />
                      </Link>
                    </p>
                    }
